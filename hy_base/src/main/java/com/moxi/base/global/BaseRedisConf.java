...
public class BaseRedisConf {
     ...
     * 管理员权限组菜单
     */
    public final static String PM_GROUP_MENU="PM_GROUP_VISIT_MENU";
    public final static String RESOURCE_TYPE="_type_";
    public final static String SET_PERMISSION_URL="set_pm_url_";
    public final static String SET_PERMISSION_ID="set_pm_Id_";
    /**
     * 用户所对应权限组
     */
