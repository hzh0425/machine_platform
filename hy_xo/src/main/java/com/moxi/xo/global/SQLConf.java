...
public final class SQLConf extends BaseSQLConf {
    ...
    public final static String LAST="limit 1";
    ...
    public final static String MPGID="mpgid";
    public final static String PID="pid";
    public final static String PGID="pgid";
    ...
    public  static final int RESOURCE_TYPE_DEPLOYMENT=1;
    public  static final int RESOURCE_TYPE_PROXY=2;
    public  static final int  RESOURCE_TYPE_TRAINSET=3;
